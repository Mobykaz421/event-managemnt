...
<div id="product-cl-sec">
    ...
    <div class="pro-header-text">New <span> Users </span></div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div id="floating-label" class="card p-20 top_border mb-3">
                                    <h2 class="_head03">Users <span>Details</span></h2>
                                    ...
                                    <div class="form-wrap p-0">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label class="PT-10 font12">Address</label>
                                                <div class="form-group" name="address" style="height: auto">
                                            ...
                                            <div class="col-md-12 PB-10">
                                                <div class="form-s2 pt-19">
                                                    <select class="form-control formselect" name="users_type"
                                                        placeholder="Select Users Type">
                                                        <option selected>Select Role Type</option>
                                                        <option value="upcomming">Attendes</option>
                                                        <option value="past">Speakers</option>
                                                        <option value="current">Sponsor</option>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-wrap p-0">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label mb-10">Start Time</label>
                                                    <input type="text" id="" name="start_time" class="form-control"
                                                        placeholder="" style="font-size:13px">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label mb-10">End Time</label>
                                    ...
                                    <div class="form-wrap p-0">
                                        <div class="row">
                                            <div class="col-md-12 PB-10">
                                                    <div class="form-group">
                                                        <label class="control-label mb-10">Ticket No</label>
                                                        <input type="text" name="end_time" id="" class="form-control"
                                                            placeholder="" style="font-size:13px">
                                                    </div>
                                            </div>
        ...
        <div class="container">
            <div class="row mt-2 mb-3">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <h2 class="_head01">Users <span>Management</span></h2>
                </div>
